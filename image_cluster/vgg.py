...
def load_net(data_path):
    ...
    mean = data['normalization'][0][0][0] # 224*224*3 each layer mean: [ 123.68   116.779  103.939]
    # print (data['classes'][0][0][0].shape)  # 1*1000
    # print (data['layers'][0].shape)
...
if __name__ == '__main__':
    load_net(r'C:\Users\yuegeng\PycharmProjects\imagenet-vgg-verydeep-19.mat')

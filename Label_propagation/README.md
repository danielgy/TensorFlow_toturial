...
![](https://github.com/danielgy/TensorFlow_toturial/tree/master/Label_propagation/images/fraction1.gif)  
其中\alpha为超参数。（另外一种构建图的方式是knn图，即只保留每个节点的k近权重，其他边为0，此时的边权重为稀疏的。）<br>
**标签传播** <br>
标签传播即通过节点间的边传播标签信息，边的权重越大，表示两个节点越相似，此时的概率转移矩阵为：<br>
![](https://github.com/danielgy/TensorFlow_toturial/tree/master/Label_propagation/images/fraction2.gif) 
